                    ...
                    <div class="panel-body">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade in active" id="ShirtSize">
                                ...
                                <div class="dataTable_wrapper">
                                    <form action="<?=URL::to('admin/order/editSize');?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <table class="table table-striped table-bordered table-hover"
                                        ...
                                        <tr>
                                            ...
                                            <td class="center">
                                                <input type="text" name="Yoke" value="<?= (isset($sizeDetail->Yoke)) ? $sizeDetail->Yoke : ''; ?>">
                                            </td>
                                        </tr>
                                        <tr>
                                            <th class="center">
                                            ...
                                            <td class="center">
                                                <input type="text" name="Tail" value="<?= (isset($sizeDetail->Tail)) ? $sizeDetail->Tail : ''; ?>">
                                            </td>
                                        </tr>
                                        <tr>
                                            <th class="center">
                                            ...
                                            <td class="center">
                                                <select class="form-control" title="Sleeve Length" name="SleeveLength">
                                        ...
                                        <tr>
                                            ...
                                            <td class="center">
                                                <input type="text" name="ShoulderLine" value="<?= (isset($sizeDetail->ShoulderLine)) ? $sizeDetail->ShoulderLine : ''; ?>">
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                                    ...
                                    <table class="table table-striped table-bordered table-hover"
                                        ...
                                        <tr>
                                            <td style="font-weight: bold;" colspan="6" class="text-center">
                                                Shirt Style - <?=$key + 1;?>
                                                <a class="btn btn-primary pull-right" href="<?= URL::to('admin/style/edit/'.$sd->ID.'');?>">
                                                    Edit
                                                </a>
                                            </td>
                                        </tr>
