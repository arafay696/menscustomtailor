                                ...
                                <div class="contentlist tab-content">
                                    ...
                                    <div class="tab-pane fade" id="Size">
                                        ...
                                        <div class="setSizeForm col-lg-12">
                                            <form id="formSizePost" method="post"
                                                  action="<?= URL::to('admin/order/save'); ?>" name="formSize">
                                                ...
                                                <input type="hidden" name="CustomerName" class="setCustomerName"
                                                       value=""/>
                                                <input type="hidden" name="CustomerEmail" class="setCustomerEmail"
                                                       value=""/>
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                    ...
                                    <div class="tab-pane fade" id="Invoice">
                                        ...
                                        <div class="col-lg-6 pull-right">
                                            <table class="table table-striped table-bordered table-hover"
                                                ...
                                                <tr>
                                                    <th>Order Date</th>
                                                    <td id="InOrderDate"></td>
                                                </tr>
                                                    <th>Bill To:</th>
                                                    <td id="InCustomerName">Abdul Rafay</td>
                                                </tr>
                                                </thead>
                                            </table>
                                        </div>
                                        ...
                                        <table class="table table-striped table-bordered table-hover"
                                            ...
                                            <tbody>
                                            <tr>
                                                <td style="font-size:10px"><b id="InProductName">Custom Dress Shirt</b><br>
                                                    <font color="#990000">Fabric Detail: </font><span id="InProductCode"></span> <br>
                                                </td>
                                                <td id="InProductPrice" align="right"></td>
                                                <td id="InProductQty" align="center"></td>
                                                <td id="InProductTotal" align="right"></td>
                                            </tr>
                                            </tbody>
                                        </table>
                                       </div>
                                        <div class="col-lg-6 pull-right">
                                            <table class="table table-striped table-bordered table-hover"
                                                ...
                                                <tr>
                                                    <th col>Sub Total</th>
                                                    <td><strong id="InSubTotal"></strong></td>
                                                </tr>
                                                <tr>
                                                    <th>Total</th>
                                                    <td id="InTotal"></td>
                                            ...
                                            <a href="<?= URL::to('/admin/orders');?>"  class="btn btn-success pull-right">
                                                Finish :)
                                            </a>
                                        </div>
                                    </div>
